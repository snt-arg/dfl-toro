...
mkdir -p /home/abrk/main_ws/src && cd /home/abrk/main_ws && catkin init

rosdep update && rosdep install --from-paths src --ignore-src --rosdistro noetic && catkin build

test -e /home/abrk/main_ws/devel/setup.bash && source /home/abrk/main_ws/devel/setup.bash

echo 'alias sourceros="source /opt/ros/noetic/setup.bash"' >> ~/.bashrc

echo 'alias sourcews="source /home/abrk/catkin_ws/devel/setup.bash && source /home/abrk/main_ws/devel/setup.bash"' >> ~/.bashrc

echo 'sourceros && sourcews' >> ~/.bashrc
